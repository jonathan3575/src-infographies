...
def render_html(qid: str) -> tuple[Path, Path, int]:
    ...
    if q.id == "00":
        ...
        print_template_name = "print_a4_4L.html.j2"
        tl_template_name = "tl_vertical_4L.html.j2"
    elif q.id in {"5L", "5C"}:
        print_template_name = "print_a4_5L.html.j2"
        tl_template_name = "tl_vertical_5L.html.j2"
    else:
